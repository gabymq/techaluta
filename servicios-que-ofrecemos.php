                ...
                <div class="content-layout">
                    <div class="content-layout-row">
                        <div class="layout-cell content clearfix"><article class="post article">
                                <h2 class="postheader">Servicios que Ofrecemos</h2>
...
<div class="content-layout layout-item-1">
    ...
    <div class="layout-cell layout-item-2" style="width: 100%" >
		<a name="Prestamos"><h2>PRESTAMOS PARA NEGOCIOS PRODUCTIVOS</h2></a>
...
<div class="content-layout layout-item-1">
    <div class="content-layout-row">
    <div class="layout-cell layout-item-2" style="width: 100%" >
		<a name="Solicitar"><h2>¿Como solicitar un préstamo?</h2></a>
        <p style="text-align:justify">Ser socio de la cooperativa<br>
Llenar su solicitud de crédito<br>
A finales del mes se reunen los del consejo de financiamiento para dictaminar las solicitudes recibidas en el mes, y se hace una lista de los socios que seran beneficiados en el mes para que pasen en los primeros 5 dias a recoger sus documentos.
Cuando pasen a la cooperativa por su cheque firmaran el pagare junto con su aval,   ahí mismo en el cheque se les descontara algun adeudo que tengan hacia la cooperativa o su seguro de deuda correspondiente. Se les entregara un programa de sus abonos en las fechas que deben de hacer sus pagos.
</p>
    </div>
    </div>
</div>
...
<div class="content-layout layout-item-1">
    ...
    <div class="layout-cell layout-item-2" style="width: 50%" >
		<a name="Tasas"><h2>Tasas de interés</h2></a>
        <ul style="text-align:justify">
		...
		<a href="files/Libro1.xls" target="_blank"><h2>Ejemplo de pago de amortizaciones al crédito</h2></a>
    </div>
    </div>
</div>
</div>
...
<div class="content-layout layout-item-1">
    <div class="content-layout-row">
    <div class="layout-cell layout-item-2" style="width: 100%" >
		<a name="Recuperacion"><h2>RECUPERACIÓN DE CRÉDITOS</h2></a>
		<ol>
		  ...
		  <li>Al llegar la primera fecha de pago el socio pasará a  la oficina de la cooperativa en donde la secretaria le ratificara o modificará  su abono.</li>
		  <li>Se le registrara en su hoja de control de pagos, la  cual firmará de conformidad checando que se haya registrado correctamente su  abono.</li>
		  <li>El gerente le entregara su recibo de abono a su  crédito.</li>
		  <li>Para proyectos de comercio o servicio este  procedimiento se efectuará cada mes y para el caso de agropecuarios solo se  realizará una sola vez siempre y cuando no hayan realizado abonos parciales.</li>
		  </ol>
