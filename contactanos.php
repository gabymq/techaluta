                ...
                <div class="content-layout">
                    <div class="content-layout-row">
                        <div class="layout-cell content clearfix"><article class="post article">
                                <h2 class="postheader">Plantilla</h2>
...
<div class="content-layout layout-item-1">
    ...
    <div class="layout-cell layout-item-2" style="width: 25%" >
		<i>Puedes visitarnos en:</i>
        <h5>Cooperativa Techaluta Cuna de Pitayas S.C. de R.L.</h5><br>
		<P>
Calle Ignacio Allende Norte S/N<br>
Local #5<br>
Techaluta de Montenegro, Jalisco; México<br>
tel: 01 372 42 45 774<br>        <br><br><br><br><br><br>
		</P>
    </div><div id="map_canvas"class="layout-cell layout-item-2" style="width: 75%" >
        <p style="text-align:justify"><b>Este Parrafo será sustituido por un Google MAP</b></p>
    </div>
	...
	<script src="js/gmaps/coordenadas_gmap.js"></script>
    </div>
</div>
</div>
...
<h2>Formulario de Contacto</h2>
        <i>o contactarnos a traves de este formulario</i>
        <!-- form -->
        ...
        <form id="contactForm" action="#" method="post">
            <fieldset>
                ...
                <input type="hidden" value="admin@techalutacunadepitayas.com" name="to" id="to" />
                <input type="hidden" value="Contacto Pagina Web" name="subject" id="subject" />
                <input type="hidden" value="send-mail.php" name="sendMailUrl" id="sendMailUrl" />
                <!-- ENDS send mail configuration -->
                
                <p style="text-align:justify"><input type="button" value="Enviar" name="submit" id="submit" /> <span id="error" class="warning">Message</span></p>
            </fieldset>
            
        </form><br>
        <p id="success" class="success">Formulario Enviado. En breve nos pondremos en contacto.</p>
        <!-- ENDS form -->
	<!-- IMPORTANTE: no olvides configurar el archivo: send-mail.php -->
    </div>
    </div>
</div>
</div>
